...
- **Every switch the dictation source reads**, in one place:
  ...
  | `WT_SCRATCHPAD_REDIRECT_KEYS=1` | re-post his keystrokes while Wispr's window is up — **off by default** since it cost both bound and spawn dictations their delivery |
